...
class Scanner:
    def __init__(self, folder_path, extensions=None):
        """
        Initialize scanner with folder path and extensions to look for.
        Defaults to PDF and DOCX.
        """
    ...
    def search_files_with_progress(self):
        """
        Generator that yields files one by one while showing a live progress bar with percentage.
        """
        ...
        with Progress(
            ...
            task = progress.add_task("[green]Scanning files...", total=total)
